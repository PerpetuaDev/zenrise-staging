...
(function () {
  ...
  var DICT = {
    en: {
      ...
      booking_s5_consent: 'I\u2019m happy for Zenrise to email me about the trip and any follow-up, and I\u2019ve read and understood the <a href="https://perpetuadev.github.io/zenrise-staging/terms.html" target="_blank" style="text-decoration: underline">booking terms &amp; conditions</a>, including the cancellation and privacy policies.',
    ...
    ja: {
      ...
      booking_s5_consent: 'Zenrise から旅行とその後のやり取りに関するメールを受け取ることに同意し、キャンセルポリシー・プライバシーポリシーを含む<a href="https://perpetuadev.github.io/zenrise-staging/terms.html" target="_blank" style="text-decoration: underline">ご予約規約</a>を読み、理解しました。',
