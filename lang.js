...
(function () {
  ...
  var DICT = {
    en: {
      ...
      tours_theme_food: 'Food',
      tours_theme_walking: 'Walking',
      tours_theme_nature: 'Views & Nature',
      tours_theme_local: 'Local Life',
      tours_theme_culture: 'Culture',
      tours_len_half: 'Half-day',
      tours_len_full: 'Full-day',
      tours_hours_4: '≈ 4 hrs',
      tours_hours_8: '≈ 8 hrs',
      tours_hours_c04: '≈ 5 hrs · 6.3 km',
      tours_c04_name: 'Kita-Kamakura to Hase',
      tours_c04_sub: 'Down from the hills, into the quiet streets of Hase.',
      tours_c01_name: 'Tsurugaoka & the Old Town',
      tours_c01_sub: 'The shrine at the city’s spine, then the lanes either side of it.',
      tours_c02_name: 'Enoshima: Coast, Caves & Seafood',
      tours_c02_sub: 'Across the causeway to the shrine, the caves, and lunch by the harbour.',
      tours_c03_name: 'Morning at the Farmers Market',
      tours_c03_sub: 'Rengetsu vegetables, back-alley coffee, and the everyday city at work.',
      tours_c05_name: 'Zen Morning: Meditation & Tea',
      tours_c05_sub: 'Zazen with a priest, then tea in a hillside garden.',
      tours_c06_name: 'Yokohama: Port, Chinatown & Lights',
      tours_c06_sub: 'The old port city from warehouse district to evening skyline.',
      ...
      td_inc_1: 'English-speaking guide',
      td_inc_2: 'Entrance fees',
      td_inc_3: 'Printed tour pamphlet, yours to keep',
      td_notinc: 'Not included',
      td_ninc_1: 'Train fares, approx. \u00a5200 per person',
      td_ninc_2: 'Breakfast, lunch and souvenirs',
      td_ninc_3: 'Additional food and drinks at the chef\u2019s counter',
      td_ninc_4: 'Hotel pick-up and drop-off',
      td_notallowed: 'Not allowed',
      td_na_1: 'Baby strollers',
      td_na_2: 'Drones',
      td_notsuitable: 'Not suitable for',
      td_ns_1: 'People with heart problems',
      td_ns_2: 'People with a low level of fitness',
      td_ns_3: 'People with pre-existing medical conditions',
      td_ns_4: 'Pregnant women',
      td_ns_5: 'Wheelchair users',
      td_book_label: 'Book this tour',
      td_cal_note: 'Mornings shown are open',
      td_travellers: 'Travelers',
      td_choose: 'Choose a morning',
      td_request: 'Request this date',
      td_route: 'The route.',
      ...
      // tour detail — No. 04
      tours_d04_title: 'Kita-Kamakura to Hase \u2014 Zenrise',
      tours_d04_eyebrow: 'Tour No. 04',
      tours_d04_cover_cap: 'Kita-Kamakura, morning',
      tours_d04_lede: 'A half-day on foot exploring the wooded hills of Kamakura & Hase side-streets, ending with a quiet lunch.',
      tours_d04_cta_eyebrow: '\u00a565,000 / group \u30fb 1\u20136 travelers',
      rt04_1_name: 'La Petite Boulangerie',
      rt04_1_note: 'Butter-rich croissants, dense country loaves, and pain de mie that holds its shape.',
      rt04_2_name: 'Tokei-ji',
      rt04_2_note: 'Plums in February, magnolia in March, hydrangea in June \u2014 the grounds are planted to flower through the year.',
      rt04_3_name: 'Jochi-ji',
      rt04_3_note: 'The temple is smaller now than it once was, and the grounds are quieter for it.',
      rt04_4_name: 'Zeniarai Benten',
      rt04_4_note: 'The trickle of running water, and the soft clink of coins shifting in wicker baskets.',
      rt04_5_name: 'Sasuke Inari',
      rt04_5_note: 'The approach runs through deep cedar woods, and the path empties out the higher you go.',
      rt04_6_name: 'Nami to Kaze',
      rt04_6_note: 'Fresh, seasonal ingredients delivered that morning, prepared in front of you.',

      // tour detail — in-preparation tours
      td_cta_eyebrow_half: '\u00a565,000 / group \u30fb 1\u20136 travelers',
      td_cta_eyebrow_full: '\u00a595,000 / group \u30fb 1\u20136 travelers',
      tours_d01_title: 'Tsurugaoka & the Old Town \u2014 Zenrise',
      tours_d01_eyebrow: 'Tour No. 01',
      tours_d01_cover_cap: 'Tsurugaoka Hachimangu',
      tours_d02_title: 'Enoshima: Coast, Caves & Seafood \u2014 Zenrise',
      tours_d02_eyebrow: 'Tour No. 02',
      tours_d02_cover_cap: 'Enoshima, from the coast',
      tours_d03_title: 'Morning at the Farmers Market \u2014 Zenrise',
      tours_d03_eyebrow: 'Tour No. 03',
      tours_d03_cover_cap: 'Kamakura, morning market',
      tours_d05_title: 'Zen Morning: Meditation & Tea \u2014 Zenrise',
      tours_d05_eyebrow: 'Tour No. 05',
      tours_d05_cover_cap: 'Morning zazen',
      tours_d06_title: 'Yokohama: Port, Chinatown & Lights \u2014 Zenrise',
      tours_d06_eyebrow: 'Tour No. 06',
      tours_d06_cover_cap: 'Yokohama at dusk',
    ...
    ja: {
      ...
      tours_theme_local: '地元の暮らし',
      tours_theme_culture: '文化',
      tours_len_half: '半日',
      tours_len_full: '一日',
      tours_hours_4: '約4時間',
      tours_hours_8: '約8時間',
      tours_hours_c04: '約5時間 · 6.3 km',
      tours_c04_name: '北鎌倉から長谷まで',
      tours_c04_sub: '山あいを抜けて、長谷の路地へ。',
      tours_c01_name: '鶴岡八幡宮と旧市街',
      tours_c01_sub: '街の背骨にあたる八幡宮と、その両側に広がる路地へ。',
      tours_c02_name: '江ノ島：海岸、岩屋、海の幸',
      tours_c02_sub: '橋を渡って神社へ、岩屋へ、そして港のそばで昼食を。',
      tours_c03_name: '朝市をめぐる午前',
      tours_c03_sub: '鎌倉野菜、路地裏のコーヒー、働く街の日常の風景。',
      tours_c05_name: '禅の朝：坐禅とお茶',
      tours_c05_sub: '僧侶とともに坐禅を組み、山肌の庭で一服のお茶を。',
      tours_c06_name: '横浜：港、中華街、夜景',
      tours_c06_sub: '倉庫街から夕暮れのスカイラインまで、古い港町を歩く。',
      ...
      td_inc_1: '英語対応ガイド',
      td_inc_2: '拝観料・入場料',
      td_inc_3: 'お持ち帰りいただける冊子（パンフレット）',
      td_notinc: '含まれないもの',
      td_ninc_1: '電車賃（お一人あたり約¥200）',
      td_ninc_2: '朝食・昼食・お土産代',
      td_ninc_3: 'カウンターでの追加のお料理・お飲み物',
      td_ninc_4: 'ホテルへの送迎',
      td_notallowed: 'ご遠慮いただくもの',
      td_na_1: 'ベビーカー',
      td_na_2: 'ドローン',
      td_notsuitable: 'ご参加をおすすめできない方',
      td_ns_1: '心臓に疾患のある方',
      td_ns_2: '体力に不安のある方',
      td_ns_3: '持病のある方',
      td_ns_4: '妊娠中の方',
      td_ns_5: '車椅子をご利用の方',
      td_book_label: 'このツアーを予約',
      td_cal_note: '表示の日付は午前に空きがあります',
      td_travellers: '人数',
      td_choose: '日付をお選びください',
      td_request: 'この日付でリクエスト',
      td_route: 'ルート。',
      td_cta_h: '一緒に歩きませんか。',
      ...
      // tour detail — No. 04
      tours_d04_title: '北鎌倉から長谷まで — Zenrise',
      tours_d04_eyebrow: 'ツアー No. 04',
      tours_d04_cover_cap: '北鎌倉、朝',
      tours_d04_lede: '鎌倉の緑深い山あいから長谷の路地までを歩いてめぐる半日。締めくくりは、静かな昼食のひとときです。',
      tours_d04_cta_eyebrow: '¥65,000 ／ 1組 ・ 1〜6名',
      rt04_1_name: '北鎌倉の小さなパン屋',
      rt04_1_note: 'バターの香り高いクロワッサン、ずっしりとしたカンパーニュ、形を崩さないパン・ド・ミ。',
      rt04_2_name: '東慶寺',
      rt04_2_note: '二月の梅、三月の木蓮、六月の紫陽花——境内は、一年を通して花の絶えない庭として整えられています。',
      rt04_3_name: '浄智寺',
      rt04_3_note: '寺はかつてよりも小さくなり、境内はその分、静かになりました。',
      rt04_4_name: '銭洗弁財天',
      rt04_4_note: '流れる水の音、そして竹籠の中で触れ合う銭の小さな響き。',
      rt04_5_name: '佐助稲荷神社',
      rt04_5_note: '参道は杉木立の中を抜け、のぼるにつれて人影がまばらになっていきます。',
      rt04_6_name: '波と風',
      rt04_6_note: 'その朝に届いた季節の食材を、目の前で仕上げてもらえます。',

      // tour detail — in-preparation tours
      td_cta_eyebrow_half: '¥65,000 ／ 1組 ・ 1〜6名',
      td_cta_eyebrow_full: '¥95,000 ／ 1組 ・ 1〜6名',
      tours_d01_title: '鶴岡八幡宮と旧市街 — Zenrise',
      tours_d01_eyebrow: 'ツアー No. 01',
      tours_d01_cover_cap: '鶴岡八幡宮',
      tours_d02_title: '江ノ島：海岸、岩屋、海の幸 — Zenrise',
      tours_d02_eyebrow: 'ツアー No. 02',
      tours_d02_cover_cap: '海岸から望む江ノ島',
      tours_d03_title: '朝市をめぐる午前 — Zenrise',
      tours_d03_eyebrow: 'ツアー No. 03',
      tours_d03_cover_cap: '鎌倉、朝の市場',
      tours_d05_title: '禅の朝：坐禅とお茶 — Zenrise',
      tours_d05_eyebrow: 'ツアー No. 05',
      tours_d05_cover_cap: '朝の坐禅',
      tours_d06_title: '横浜：港、中華街、夜景 — Zenrise',
      tours_d06_eyebrow: 'ツアー No. 06',
      tours_d06_cover_cap: '夕暮れの横浜',
